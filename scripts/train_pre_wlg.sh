#!/bin/bash
#$ -N train_pre_wlg_cont
#$ -q long.q@*
#$ -l ram_free=64G,mem_free=64G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=40G
#$ -o /mnt/matylda6/isedlacek/projects/eloquence/t2.5/speech_llm/exp/job_logs/train_pre_wlg_cont.o
#$ -e /mnt/matylda6/isedlacek/projects/eloquence/t2.5/speech_llm/exp/job_logs/train_pre_wlg_cont.e
N_GPUS=2
EXPERIMENT="train_pre_wlg_cont"
#
...
args=(
    ...
    --from_pretrained "/mnt/matylda6/isedlacek/projects/eloquence/t2.5/speech_llm/exp/train_pre_wlg"
