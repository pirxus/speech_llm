...
def main(args):
    ...
    # create the speech preprocessor for dataset
    speech_processor = AutoProcessor.from_pretrained(args.speech_processor_id)
...
def parse_args():
    ...
    model_group.add_argument(
        ...
        help="HuggingFace processor ID for feature extraction",
    )
    model_group.add_argument(
